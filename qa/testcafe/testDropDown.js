...
import { Selector, t } from 'testcafe';
  ...
  test('testDropDown', async t => {
    ...
    await t
      ...
      .expect(Selector('div[rel="v-s:hasTransportKind"] span#label').innerText.trim()).eql('Авиатранспорт')
      .click('veda-control[rel="v-s:hasTransportKind"] div.dropdown')
      .click('veda-control[rel="v-s:hasTransportKind"] div.fulltext-menu span.cancel-selection')
      .wait(1000)
      ...
      .expect(Selector('div[rel="v-s:hasTransportKind"] span#label').innerText.trim()).eql('Железнодорожный транспорт')
      .click('veda-control[rel="v-s:hasTransportKind"] div.dropdown')
      .click('veda-control[rel="v-s:hasTransportKind"] div.fulltext-menu span.cancel-selection')
      .wait(1000)
      ...
      .expect(Selector('div[rel="v-s:hasTransportKind"] span#label').innerText.trim()).eql('Автобус')
      ...
      .expect(Selector('div[rel="v-s:hasTransportKindSingle"] span#label').innerText.trim()).eql('Авиатранспорт')
