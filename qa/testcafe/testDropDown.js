...
import { Selector, t } from 'testcafe';
  ...
  test('testDropDown', async t => {
    ...
    await t
      ...
      .expect(Selector('veda-control[rel="v-s:hasTransportKind"] .suggestions .suggestion.selected').count).eql(3)
      .click('veda-control[rel="v-s:hasTransportKind"] .fulltext-menu .suggestions a[resource="d:62fbbbc27f8e407c8f51de71e10d0501"]')
      ...
      .click('veda-control[rel="v-s:hasTransportKind"] .fulltext-menu .cancel-selection')
      .expect(Selector('veda-control[rel="v-s:hasTransportKind"] .suggestions .suggestion.selected').count).eql(0)
      .click('veda-control[rel="v-s:hasTransportKind"] .fulltext-menu .suggestions a[resource="d:2078749d2bcf42e0ae80c5d8287d19d1"]')
      ...
      .click('veda-control[rel="v-s:hasTransportKind"] .fulltext-menu .cancel-selection')
      .wait(1000)
      .click('veda-control[rel="v-s:hasTransportKind"] .fulltext-menu .suggestions a[resource="d:177b4624ed3f4ce6a1c89d7a3bd4f1c1"]')
      .click('veda-control#label')
      .expect(Selector('div[rel="v-s:hasTransportKind"] span#label').innerText).eql('Железнодорожный транспорт')
      .click('veda-control[rel="v-s:hasTransportKind"] .dropdown')
      .click('veda-control[rel="v-s:hasTransportKind"] .fulltext-menu .cancel-selection')
      .wait(1000)
      .doubleClick('veda-control[rel="v-s:hasTransportKind"] .fulltext-menu .suggestions a[resource="d:62fbbbc27f8e407c8f51de71e10d0501"]')
      ...
      .click('veda-control[rel="v-s:hasTransportKindSingle"] .fulltext-menu .suggestions a[resource="d:2078749d2bcf42e0ae80c5d8287d19d1"]')
