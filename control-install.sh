...
if ! dmd --version | grep 2.069.0 ; then    
...
# Patch DMD
sudo cp ./qa/patch_dmd_2_69_0/concurrency.d /usr/include/dmd/phobos/std/concurrency.d
sudo cp ./qa/patch_dmd_2_69_0/concurrency.d ${HOME}/dmd2/src/phobos/std/concurrency.d
