 ...
 * обработка событий
 */
module veda.core.impl.bus_event;

private import std.outbuffer, std.stdio, std.concurrency, std.datetime, std.conv, std.json;
private import backtrace.backtrace, Backtrace = backtrace.backtrace;
private import veda.util.container, util.logger, veda.core.util.utils, veda.util.cbor8individual, veda.util.individual8json, veda.util.cbor8json;
private import veda.type, veda.core.common.know_predicates, veda.core.common.context, veda.core.common.define;
 ...
 */
        ...
        else
        {
            version (libV8)
            {
                ...
                veda.core.glue_code.scripts.send_put(context, ticket, ev_type, new_state, prev_state, rdfType, individual.uri, event_id, op_id);
            }
        }
    }
}
