...
fn after_batch(_module: &mut Module, ctx: &mut Context, _prepared_batch_size: u32) -> bool {
...
fn prepare(_module: &mut Module, module_info: &mut ModuleInfo, ctx: &mut Context, queue_element: &mut Individual, _count_popped: u32) -> Result<bool, PrepareError> {
