...
use v_v8::v_common::module::module::{get_cmd, get_info_of_module, get_inner_binobj_as_individual, init_log, wait_load_ontology, wait_module, Module, PrepareError};
...
fn setup() -> SetupGuard {
    ...
    START.call_once(|| {
        assert!(v8::icu::set_common_data(align_data::include_aligned!(align_data::Align16, "third_party/icu/common/icudtl.dat")).is_ok());
