...
Если требуется вносить изменения в ядро платформы, то возможно самостоятельно собрать платформу: [1.1.2 Самостоятельная сборка из исходных текстов](#112-самостоятельная-сборка-из-исходных-текстов). Необходимо учесть, что в таком варианте понадобится не менее 2 ГБ оперативной памяти.
...
Здесь мы выведем на экран название поля cs:name, оно было описано ранее при описании свойств  класса cs:Customer.
