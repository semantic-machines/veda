...
## Руководство по разработке приложений
   ...
   * [Руководство по разработке приложений.](#руководство-по-разработке-приложений)
      * [Предисловие](#предисловие)
       ...
       * [1. Установка и настройка](#1-установка-и-настройка)
          ...
          * [1.4. Клиентская часть, веб-браузер](#14-клиентская-часть-веб-браузер)
             * [Системные требования](#системные-требования-1)
          * [1.5. Cредства разработки](#15-cредства-разработки)
       ...
       * [ПРИЛОЖЕНИЕ](#приложение)
          * [Скрипты отвечающие за назначение прав автору новой сущности](#скрипты-отвечающие-за-назначение-прав-автору-новой-сущности)
...
4) Каждый генератор описывает:
  ...
  10) Или создавать генераторы прав, где указываются не группы субъекта и объекта, а их генераторы и соответствующие целевые значения. Это позволит не вычислять вручную uri групп для прав. На основе генераторов прав создаются об