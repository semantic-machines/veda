...
veda.Module(function (veda) { "use strict";
  ...
  veda.IndividualModelAsync.prototype = Object.create(veda.IndividualModel.prototype);
  veda.IndividualModelAsync.prototype.constructor = veda.IndividualModelAsync;
  ...
  function parser(value) {
    if (value.type === "String") {
      ...
      return new veda.IndividualModelAsync(value.data);
  ...
  Object.defineProperty(proto, "rights", {
    get: function () {
      ...
      if (this._.isNew || this.hasValue("v-s:isDraft", true)) {
        this._.rights = new veda.IndividualModelAsync(undefined, undefined, undefined, undefined, false);
  ...
  proto.load = function (uri) {
    ...
    if (typeof uri === "string") {
      ...
      if (this._.cache && veda.cache[uri]) {
        var resolved = Promise.resolve( veda.cache[uri] );
        this.trigger("individual:afterLoad", resolved);
        return resolved;
      } else {
        return get_individual(veda.ticket, uri, undefined, true)
          .then(function (data) {
    ...
    var resolved = Promise.resolve( this );
    this.trigger("individual:afterLoad", resolved);
    return resolved;
  };
