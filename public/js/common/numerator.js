...
veda.Module(function (veda) { "use strict";
  ...
  veda.Numerator.numerate = function (ticket, individual, super_classes, prev_state, _event_id) {
    try {
   ...
   * @returns
   */
  veda.Numerator.getNextValueSimple = function (ticket, scope, FIRST_VALUE) {
  ...
  veda.Numerator.isNumerationValueAvailable = function (scope, value) {
    if (typeof window === 'undefined') {
