...
//////////////////////////
  ...
  window.remove_individual = function (ticket, uri, assigned_modules, event_id, transaction_id) {
    var arg = arguments[0];
    var isObj = typeof arg === "object";
    var params = {
      type: "PUT",
      ...
      data: JSON.stringify({
        "ticket": isObj ? arg.ticket : ticket,
        "uri": isObj ? arg.uri : uri,
        "assigned_modules": (isObj ? arg.assigned_modules : assigned_modules) || 0,
  ...
  window.put_individual = function (ticket, individual, assigned_modules, event_id, transaction_id) {
    var arg = arguments[0];
    var isObj = typeof arg === "object";
    var params = {
      type: "PUT",
  ...
  window.add_to_individual = function (ticket, individual, assigned_modules, event_id, transaction_id) {
    var arg = arguments[0];
    var isObj = typeof arg === "object";
    var params = {
      type: "PUT",
  ...
  window.set_in_individual = function (ticket, individual, assigned_modules, event_id, transaction_id) {
    var arg = arguments[0];
    var isObj = typeof arg === "object";
    var params = {
      type: "PUT",
  ...
  window.remove_from_individual = function (ticket, individual, assigned_modules, event_id, transaction_id) {
    var arg = arguments[0];
    var isObj = typeof arg === "object";
    var params = {
      type: "PUT",
  ...
  window.put_individuals = function (ticket, individuals, assigned_modules, event_id, transaction_id) {
    var arg = arguments[0];
    var isObj = typeof arg === "object";
    var params = {
      type: "PUT",
