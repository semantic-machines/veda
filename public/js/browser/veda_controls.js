...
// Generic control behaviour
	$.fn.vedaControl2 = function( $el, options ) {
		var opts = $.extend( {}, $.fn.vedaControl2.defaults, options ),
			control = $(opts.template),
			immutable = opts.immutable;
	...
	// String control
	$.fn.vedaString2 = function( options ) {
		var opts = $.extend( {}, $.fn.vedaString2.defaults, options ),
			control = $.fn.vedaControl2(this, opts);
	...
	$.fn.vedaString2.defaults = {
		value: new String(""),
		template: $("#string-control-template2").html(),
		change: function (value) { alert(value + " : " + value.language) },
		inputParser: function (input, el) {
			var value = new String(input);
			value.language = $(el).data("language");
	...
	// Boolean control	
	$.fn.vedaBoolean2 = function( options ) {
		var opts = $.extend( {}, $.fn.vedaBoolean2.defaults, options ),
			control = $.fn.vedaControl2(this, opts);
		this.append(control);
		return this;
	};
	$.fn.vedaBoolean2.defaults = {
		value: new Boolean(false),
		template: $("#boolean-control-template2").html(),
		inputParser: function (input) {
	...
	// Integer control
	$.fn.vedaInteger2 = function( options ) {
		var opts = $.extend( {}, $.fn.vedaInteger2.defaults, options ),
			control = $.fn.vedaControl2(this, opts);
		this.append(control);
		return this;
	};
	$.fn.vedaInteger2.defaults = {
		value: undefined,
		template: $("#integer-control-template2").html(),
		inputParser: function (input) {
	...
	// Decimal control
	$.fn.vedaDecimal2 = function( options ) {
		var opts = $.extend( {}, $.fn.vedaDecimal2.defaults, options ),
			control = $.fn.vedaControl2(this, opts);
		this.append(control);
		return this;
	};
	$.fn.vedaDecimal2.defaults = {
		value: undefined,
		template: $("#decimal-control-template2").html(),
		inputParser: function (input) {
	...
	// Datetime control
	$.fn.vedaDatetime2 = function (options) {
		var opts = $.extend( {}, $.fn.vedaDatetime2.defaults, options ),
			control = $.fn.vedaControl2(this, opts);
		this.append(control);
		return this;
	};
	$.fn.vedaDatetime2.defaults = {
		value: undefined,
		template: $("#datetime-control-template2").html(),
		inputParser: function (input) {
	...
	// Source code control
	$.fn.vedaSource2 = function (options) {
		var self = this,
			opts = $.extend( {}, $.fn.vedaSource2.defaults, options ),
			immutable = opts.immutable,
			control = $(opts.template),
			fscreen = $("#full-screen", control),
			editorEl = control.get(0),
	...
	$.fn.vedaSource2.defaults = {
		value: new String(""),
		template: $("#source-control-template2").html(),
		mode: "javascript", 
		inputParser: function (input) {
	...
	// Object property control
	$.fn.vedaLink2 = function( options ) {
		var opts = $.extend( {}, $.fn.vedaLink2.defaults, options ),
			control = $(opts.template),
			queryPrefix = opts.queryPrefix,
			add = $(".add", control),
			all = $(".all", control);
	...
	$.fn.vedaLink2.defaults = {
		template: $("#link-control-template2").html(),
		queryPrefix: ""
	};
