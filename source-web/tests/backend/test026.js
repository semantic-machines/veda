export default ({it, assert, Backend, Helpers, Constants, Util}) => {
  it(`#026 Check different group subtrees (1)`, async () => {
    ...
    res = await Helpers.addRight(ticket_admin.ticket, ticket1.user_uri, group_B, ['v-s:canRead', 'v-s:canUpdate', 'v-s:canDelete']);
    ...
    await Helpers.check_rights_success(ticket1.ticket, new_test_doc1['@'], ['v-s:canUpdate']);

    await Helpers.check_rights_success(ticket1.ticket, new_test_doc1['@'], ['v-s:canDelete']);
