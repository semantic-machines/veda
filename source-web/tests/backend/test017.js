export default ({test, assert, Backend, Helpers, Constants, Util}) => {
  test(`#017 Nested groups with restrictions (1)`, async () => {
    ...
    // Stage 3: Login as user1 and setup complex group structure + rights
    await Backend.logout();
    await Helpers.get_user1_ticket();
    ...
    await Helpers.check_rights_fail(doc3['@'], ['v-s:canUpdate']);
    await Helpers.check_rights_fail(doc3['@'], ['v-s:canDelete']);
