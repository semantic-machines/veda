      ...
      <div class="section-content">
        ...
        <div class="row row-attribute">
          ...
          <div class="col-sm-9 col-xs-7">
            ...
            <veda-control data-type="link" rel="v-ui:forProperty" class="-view edit search fulltext dropdown"
              data-query-prefix="'rdf:type'=='owl:DatatypeProperty' || 'rdf:type'=='owl:ObjectProperty'" data-template="{@.rdfs:label}, {@.id}"></veda-control>
          </div>
        </div>
        <div class="row row-attribute">
          <div class="col-sm-3 col-xs-5">
