...
export const html = `
  <div class="container sheet" style="position:relative;">
    ...
    <li role="presentation"><a href="#Registries" aria-controls="Registries" role="tab" data-toggle="tab" about="v-s:RegistriesBundle" property="rdfs:label"></a></li-->
      ...
      <li role="presentation">
        <a href="#BugReports" aria-controls="BugReports" role="tab" data-toggle="tab" about="v-s:BugReportsBundle" property="rdfs:label"></a>
      </li>
      ...
      <div role="tabpanel" class="tab-pane" id="Classes">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <span about="v-s:ClassRegistry" property="rdfs:label"></span
                ><a href="#/v-s:ClassBlank" about="v-s:CreateBundle" property="rdfs:label" class="btn btn-xs btn-default pull-right"></a>
              </div>
          ...
          <div class="col-md-6">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <span about="v-s:PropertyRegistry" property="rdfs:label"></span
                ><a href="#/v-s:PropertyBlank" about="v-s:CreateBundle" property="rdfs:label" class="btn btn-xs btn-default pull-right"></a>
              </div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <span about="v-s:ClassTemplateRegistry" property="rdfs:label"></span
                ><a href="#/v-s:ClassTemplateBlank" about="v-s:CreateBundle" property="rdfs:label" class="btn btn-xs btn-default pull-right"></a>
              </div>
      ...
      <div role="tabpanel" class="tab-pane" id="Rights">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <span about="v-s:GroupRegistry" property="rdfs:label"></span
                ><a href="#/v-s:GroupBlank" about="v-s:CreateBundle" property="rdfs:label" class="btn btn-xs btn-default pull-right"></a>
              </div>
          ...
          <div class="col-md-6">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <span about="v-s:PersonRegistry" property="rdfs:label"></span
                ><a href="#/v-s:PersonBlank" about="v-s:CreateBundle" property="rdfs:label" class="btn btn-xs btn-default pull-right"></a>
              </div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <span about="v-s:GroupGenerator" property="rdfs:label"></span
                ><a href="#/v-s:GroupGeneratorBlank_Admin" about="v-s:CreateBundle" property="rdfs:label" class="btn btn-xs btn-default pull-right"></a>
              </div>
          ...
          <div class="col-md-6">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <span about="v-s:PermissionGeneratorRegistry" property="rdfs:label"></span
                ><a href="#/v-s:PermissionGeneratorBlank_Admin" about="v-s:CreateBundle" property="rdfs:label" class="btn btn-xs btn-default pull-right"></a>
              </div>
