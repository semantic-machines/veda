...
export const pre = function (individual, template, container, mode, extra) {
  ...
  props.append (
    properties.map( function (property_uri, index, array) {
      ...
      $(".name", result).append (
          $("<strong></strong>", {"about": property_uri, "property": "rdfs:label"}).addClass("text-muted")
      );
      ...
      switch ( range ) {
        ...
        case "xsd:string":
          if (property_uri === "v-s:script" || property_uri === "v-ui:template") {
            ...
            $(".value", result).append (
                "<div property='" + property_uri + "' class='view -edit -search'></div>" +
        ...
        default:
          if (property_uri === "v-s:attachment") {
            $(".value", result).append (
                "<div rel='" + property_uri + "' data-template='v-ui:FileTemplateWithComment' data-embedded='true'></div>" +
                "<veda-control rel='" + property_uri + "' data-type='file' class='-view edit -search'></veda-control>"
            );
          } else {
            $(".value", result).append (
                "<div rel='" + property_uri + "' data-template='v-ui:ClassNameLabelLinkTemplate'></div>" +
  ...
  <div class="container sheet">
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-xs-7">
        ...
        <veda-control rel="rdf:type" data-type="link" data-template="{@.rdf:type.rdfs:label} : {@.rdfs:label}" class='-view edit search fulltext dropdown'></veda-control>
      </div>
    </div>
    <hr style="margin: 10px 0px"/>
    <div class="row">
