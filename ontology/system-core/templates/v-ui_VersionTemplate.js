  ...
  <p class="pull-left">
    ...
    <span about="@" rel="v-s:actualVersion">
      <a href="#/@" class="alert-link">
        &uarr; <span about="v-s:actualVersion" property="rdfs:label"></span>
      </a>
    </span>
  </p>
  <p class="pull-right">
    <span about="@" rel="v-s:previousVersion">
      <a href="#/@" class="alert-link">
        &larr; <span about="v-s:previousVersion" property="rdfs:label"></span>
      </a>
    </span>
    <span about="@" rel="v-s:nextVersion">
      <a href="#/@" class="alert-link">
        <span about="v-s:nextVersion" property="rdfs:label"></span> &rarr;
      </a>
    </span>
  </p>
</div>
