  ...
  <div class="container sheet">
    ...
    <div class="row row-attribute">
      ...
      <div class="col-sm-9 col-xs-7">
        ...
        <veda-control rel="v-s:parentUnit" data-query-prefix="('rdf:type'=='v-s:Department' && 'v-s:parentOrganization'=='{@.v-s:parentOrganization.id}') || '@'=='{@.v-s:parentOrganization.id}'" data-type="link" class="-view edit search fulltext dropdown notEditForUsers"></veda-control>
      </div>
    </div>
    <div class="row row-attribute">
      <div class="col-sm-3 col-xs-5">
