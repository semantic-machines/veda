  ...
  <div class="container sheet">
    ...
    <div id="mainProperties">
      ...
      <div about="@" rel="v-s:parentOrganization" class="view edit -search">
        <a href="#/@"> <span property="v-s:taxId"></span> - <span property="v-s:shortLabel"></span> - <span property="v-s:legalAddress"></span> </a>
      </div>
      ...
      <veda-control
        ...
        data-query-prefix="('rdf:type'=='v-s:Department' && 'v-s:parentOrganization'=='{@.v-s:parentOrganization.id}') || '@'=='{@.v-s:parentOrganization.id}'"></veda-control>
